...
const STUDY_ID = 'CD-WORKLOAD-20260830-006';
const MODULE_ID = 'CD006-CANONICAL-LEXICAL-ENRICHED-BIOGRAPHY-001';
const PATH_ID = 'P1';
const CONTRACT_ID = 'CD006-QC-1.0';
const ROOT = process.cwd();

const taskFile = path.join(
  ROOT,
  'prompts/CD-WORKLOAD-20260830-006-neutral-task.txt'
);
...
const providerFile = path.join(
  ROOT,
  'data/CD-WORKLOAD-20260830-006-provider.json'
);
...
function fail(message) {
  console.error('STUDY006_P1_ERROR:', message);
  process.exit(1);
}
...
for (const field of [
  'design_frozen',
  'neutral_preservation_rules_frozen',
  'authority_evidence_frozen',
...
if (mode === '--preflight') {
  console.log('========================================');
  console.log('STUDY 006 P1 CANONICAL FIDELITY FEASIBILITY RUNNER PREFLIGHT');
  console.log('========================================');
  console.log('STUDY_ID:', STUDY_ID);
  console.log('MODULE_ID:', MODULE_ID);
  console.log('PATH:', PATH_ID);
  console.log('OBSERVATION_RESERVED:', 'CD-006-P1-0001');
...
if (mode !== '0001') {
  fail('Usage: node scripts/run-study006-p1.mjs --preflight OR 0001');
}
...
const observationId = 'CD-006-P1-0001';
