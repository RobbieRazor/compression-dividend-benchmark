...
CONTRACT_ID = "CD005-QC-1.0"
TARGET_ID = "CD005-ENRICHED-BIOGRAPHY-SCHEMA-TARGET-1.0"
EVALUATOR_ID = "CD005-STRICT-SCHEMA-EVAL-1.0"

ROOT = Path.cwd()

QC_FILE = ROOT / "data/CD-WORKLOAD-20260830-005-quality-contract.json"
TARGET_FILE = ROOT / "data/CD-WORKLOAD-20260830-005-enriched-biography-target-representation.json"
AUTHORITY_CONTROL_FILE = ROOT / "data/CD-WORKLOAD-20260830-005-enriched-biography-public-authority-package.json"
...
TASK_METADATA_FILE = ROOT / "data/CD-WORKLOAD-20260830-005-task-metadata.json"
PROVIDER_FILE = ROOT / "data/CD-WORKLOAD-20260830-005-provider.json"
EVALUATOR_FILE = ROOT / "scripts/evaluate-study005.py"


def fail(message):
    print("STUDY005_EVALUATOR_ERROR:", message)
    raise SystemExit(1)
...
if authority_control.get("status") != "INDEPENDENT_PUBLIC_AUTHORITY_EVIDENCE_FROZEN_WITH_EXACT_STUDY004_BYTES":
    fail("Study 005 authority evidence is not frozen.")
...
if len(sys.argv) == 2 and sys.argv[1] == "--preflight":
    ...
    print("========================================")
    print("STUDY 005 STRICT SCHEMA EVALUATOR PREFLIGHT")
    print("========================================")
...
if len(sys.argv) != 2 or not re.fullmatch(r"P[123]-\d{4}", sys.argv[1]):
    fail("Usage: python3 scripts/evaluate-study005.py --preflight OR P1-0001 OR P2-0001 OR P3-0001")

path_number = sys.argv[1]
observation_id = "CD-005-" + path_number
...
print("========================================")
print("STUDY 005 STRICT SCHEMA QUALITY EVALUATION")
print("========================================")
