...
if (
  ...
  fail(
    "P1 cache breakpoints must be zero."
  );
}
...
if (
  ...
  fail(
    "Answer-key visibility boundary violated."
  );
}
...
const selectedPath =
  metadata
    .explicit_surface_selection
    ?.selected_jsonld_path;
...
if (
  ...
  fail(
    "Unexpected selected public surface."
  );
}
...
if (!sourceExpected) {
  fail(
    "Frozen authority-source hash missing."
  );
}
...
if (
  ...
  fail(
    "Frozen authority source hash mismatch."
  );
}
...
if (
  ...
  fail(
    "Usage: node scripts/run-study003-p1.mjs --preflight OR 0001"
  );
}
